...
public class MailBody {
    ...
    public String customMessage(final String orderCode, String brandName, OrderInfo orderInfo)
            throws UnknownHostException {
        String mailbody = "¡Hola " + brandName + " lover!<br><br>";
        ...
        for (int i = 0; i < orderInfo.getProductos().size(); i++) {
            mailbody += "<tr><td style='border: 1px solid black'>" + orderInfo.getProductos().get(i).getNombre()
                    + "</td>";
            mailbody += "<td style='border: 1px solid black'>" + orderInfo.getProductos().get(i).getCantidad()
                    + "</td>";
            mailbody += "<td style='border: 1px solid black'>$" + orderInfo.getProductos().get(i).getPrecio()
                    + "</td></tr>";
        ...
        mailbody += "</table><br>";
        mailbody += "<b>El tiempo estimado de envío es de 5 a 7 días hábiles</b>, agradecemos tu comprensión.<br><br>";
    ...
    public String orderDelivery(final String orderCode, String brandName)
        ...
        mailbody += "Recuerda que los <b>tiempos de despacho son entre 5 y 7 días hábiles</b>.<br><br>";
    ...
    public String storeMessage(final String orderCode, String brandName, OrderInfo orderInfo)
        ...
        mailbody += "1.- Prepara el pedido y una vez lo tengas listo haz <a href='" + link + "'>Click aquí</a><br>";
        mailbody += "2.- Procesa la venta como harías normalmente. No olvides marcar la casilla 'catálogo' e ingresar los datos del cliente.<br>";
